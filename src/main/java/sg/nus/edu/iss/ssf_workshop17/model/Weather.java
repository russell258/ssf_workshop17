...
public class Weather implements Serializable{
    ...
    //marshalling, parse the string into  java object
    public static Weather create(String json) throws IOException{
        Weather w = new Weather();
        try (InputStream is = new ByteArrayInputStream(json.getBytes())){
            //supposed to return weather i.e. java object but this is building json object
            JsonReader r = Json.createReader(is);
            JsonObject o = r.readObject();
            // this is using java class setter to set by getting from the object.
